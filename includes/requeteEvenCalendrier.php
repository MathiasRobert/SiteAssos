...
$stmt = $pdo->prepare("SELECT even_id as url, even_titre as title, even_dateDeb as start, even_heureDeb, even_heureFin, asso_couleur as color FROM EVENEMENT, ASSOCIATION WHERE ASSOCIATION.asso_id=EVENEMENT.asso_id");
$stmt->execute();
